...
run_case("Case A: H → H (identity)", qc_sv_a, qc_a)
run_case("Case B: H → Z → H (HZH)", qc_sv_b, qc_b)

print("\nInterpretation:")
print("Interference converts relative phase into observable amplitude differences.")
